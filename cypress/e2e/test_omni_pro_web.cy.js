...
describe('Test for alkosto in web', () => {
  it('Validate happy path in purchase a product with registered user', () => {
      ...
      getElement(locators.searchResults).should('be.visible').contains('Series S').click()
      ...
      getElement(locators.continuePaymentPse).should('be.visible').eq(0).click()
      ...
      getElement(locators.selectClientType).should('be.visible').click()

      getElement(locators.listOfOptions).should('be.visible').contains('Natural').click()

      getElement(locators.selectTypeOfDocument).should('be.visible').eq(1).click()

      getElement(locators.selectDocument).should('be.visible').eq(1).click()
      ...
      getElement(locators.payNowButton).should('be.visible').and('be.enabled')
  }),
